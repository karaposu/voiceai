...
python -m voxengine.smoke_tests.test_provider_integration
"""
...
async def test_provider_adapter():
    ...
    from voxengine.providers import get_registry, MockConfig
    from voxengine.core.provider_protocol import ProviderConfig as CoreProviderConfig
    from voxengine.core.stream_protocol import StreamConfig, AudioFormat
